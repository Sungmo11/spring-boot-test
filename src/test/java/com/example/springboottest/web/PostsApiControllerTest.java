...
public class PostsApiControllerTest {
    ...
    @Test
    @WithMockUser(roles="USER") /* 인증된 모의(가짜) 사용자를 만들어서 사용함 / roles에 권한을 추가할 수 있음 / 즉, 이 어노테이션으로 인해 ROLE_USER 권한을 가진 사용자가 API를 요청하는 것과 동일한 효과 */
    public void Posts_등록된다() throws Exception
    {
        ...
        // when
        /* mvc.perform() 생성된 MockMvc를 통해 API를 테스트 함 / 본문(Body) 영역은 문자열로 표현하기 위해 ObjectMapper를 통해 문자열 JSON으로 변환함 */
